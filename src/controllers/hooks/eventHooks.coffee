expansions = {
  'ENTERTAINMENT':['ATTRACTIONS', 'AMUSEMENT', 'ARCADES', 'GALLERIES', 'BOWLING', 'BREWERIES', 'CASINOS', 'CHILDREN', 'COMEDY','FESTIVALS', 'FARMERS', 'ORCHARDS','FINEARTS','GOLF' , 'HISTORIC', 'LIBRARY', 'MOVIE', 'MUSEUMS', 'NIGHTLIFE', 'PARKS', 'PERFORMING','PERFORMINGARTS', 'PETS',"SPORTS", 'SHOPPING', 'STADIUM', 'THEATERES', 'UNIQUE', 'WINERIES', 'ZOOS','CLASSICROCK', 'FOLK', 'ALTERNATIVE', 'CLASSICAL', 'ELECTRONICA', 'POP', 'ROCK', 'ACOUSTIC', 'JAZZ', 'RAP', 'COUNTRY', 'METAL', 'REGGAE', 'PROGRESSIVE', 'PUNK', 'HOLIDAY', "BLUES", "AMERICANA", "CHILD", "CHRISTIAN", "DANCE", "EXPERIMENTAL", "INDIE", "LATIN", "NEWAGE", "REGGAE", "SOUL", "ROCKABILLY","TRIBUTE","VARIOUS","WORLD", 'EXHIBITS', 'EXPOS', 'BARGAMES', 'DRINK', 'HISTORICAL', 'BUSINESS', 'CHARITY', 'TEENS', 'NEIGHBORHOOD', 'ENTREPRENEUR', 'FAITH', 'FAMILY', 'FAIRS', 'FILM', 'FOODS', 'WELLNESS', 'LGBT', 'LITERARY',"CONCERT", 'CONCERTS', 'OTHER', 'POLITICAL','SCHOOL', 'SCIENCE', 'FITNESS','VISUAL', 'PROFESSIONAL', "COMMUNITY", "COLLEGE-SPORTS"]
